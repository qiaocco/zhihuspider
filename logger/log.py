...
log_path = log_dir.joinpath("weibo.log")
...
log_config = {
    ...
    "loggers": {
        "crawler": {"handlers": ["console", "file"], "level": "DEBUG"},
        "parser": {"handlers": ["file"], "level": "INFO"},
        "other": {"handlers": ["console", "file"], "level": "INFO"},
        "storage": {"handlers": ["file"], "level": "INFO"},
    },
}
